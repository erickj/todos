...
class RSpecLogging
  include Logging
  setup_parent_logger :fatal, :stderr
end
...
RSpec.configure do |config|
  ...
  if ENV['RSPEC_LOG_LEVEL']
    RSpecLogging.loglevel(ENV['RSPEC_LOG_LEVEL'].intern)
  end
...
#  config.profile_examples = 10
  ...
  # See http://datamapper.org/getting-started.html for DB URL examples
  # e.g.:
  ...
  config.around(:each) do |spec|
    # Raise errors on model save failures. Reset before each test to allow
    # individual contexts to disable the setting, e.g. when testing for
    # validation errors.
    DataMapper::Model.raise_on_save_failure = true

    # Execute each spec inside of a database transaciton
